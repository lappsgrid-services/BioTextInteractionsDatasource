...
public class BioTextInteractionsDatasource implements DataSource
{
	private static final Logger logger = LoggerFactory.getLogger(BioTextInteractionsDatasource.class);
	...
	public BioTextInteractionsDatasource() {}
	...
	private String readSentence(String fname)
	{
		...
		try {
			...
			java.util.logging.Logger.getLogger(BioTextInteractionsDatasource.class.getName()).log(Level.SEVERE, null, ex);
		}
